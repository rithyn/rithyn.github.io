                        ...
                        if (clientselect) {
                            clientselect.addEventListener('change', function() {
                                ...
                                switch (selectedValue) {
                                    case 'da':
                                        clientLink = 'https://cdn.jsdelivr.net/gh/immagangster2/immagangster2.github.io@latest/client/eot2.user.js';
                                        break;
                                    case 'de':
                                        clientLink = 'https://cdn.jsdelivr.net/gh/immagangster2/immagangster2.github.io@latest/client/nebu2.user.js';
                                        break;
                                    case 'du':
                                        clientLink = 'https://cdn.jsdelivr.net/gh/immagangster2/immagangster2.github.io@latest/client/troll2.user.js';
                                        break;
                                    default:
                                        clientLink = '';
                                        break;
