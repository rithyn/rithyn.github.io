                ...
                if (socialDie1) {
                    ...
                    loveIcon.addEventListener("mousedown", function(event) {
                        ...
                        if (applyChangesBtn) {
                            ...
                            applyChangesBtn.addEventListener('change', function() {
                                var selectedValue = this.value;
                                var clientLink;

                                switch (selectedValue) {
                                    case 'da':
                                        clientLink = 'https://cdn.jsdelivr.net/gh/immagangster2/immagangster2.github.io@latest/client/eot1.user.js';
                                        break;
                                    case 'de':
                                        clientLink = 'https://cdn.jsdelivr.net/gh/immagangster2/immagangster2.github.io@latest/client/nebu1.user.js';
                                        break;
                                    case 'du':
                                        clientLink = 'https://cdn.jsdelivr.net/gh/immagangster2/immagangster2.github.io@latest/client/troll1.user.js';
                                        break;
                                    default:
                                        clientLink = '';
                                        break;
